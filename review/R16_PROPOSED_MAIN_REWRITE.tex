...
\author{}
\date{Draft readability rewrite}
...
Alternating the chronological references reduces direct overlap between adjacent comparisons. Ida remains larger than every retained reference in both alternating phases. This sensitivity does not make the windows independent, but it shows that the descriptive result is not driven solely by counting both sides of each adjacent pair.
