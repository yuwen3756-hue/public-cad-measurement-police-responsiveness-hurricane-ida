...
\date{26 August 2026\\[0.2em]\small Separate technical archive}
...
The Ida statistic belongs to the released-record side of \cref{eq:observation_map}. Let $G(Y)$ be the standardized ten-bin public-field contrast matrix defined below. The archived empirical layer uses
\begin{equation}
