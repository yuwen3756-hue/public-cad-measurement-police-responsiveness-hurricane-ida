...
\section{Validating police-service measures under environmental and system stress}
...
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.24\textwidth}>{\raggedright\arraybackslash}p{0.28\textwidth}>{\raggedright\arraybackslash}X@{}}
\toprule
...
Report the initiation rule, duplicate and cancellation treatment, and counts by documented stream. &
Supports interpretation as demand rather than record production. \\
Response time &
What are the start and end points of the response clock, and what share of calls contains both? &
